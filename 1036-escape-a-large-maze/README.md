<h2><a href="https://leetcode.com/problems/escape-a-large-maze/">1106. Escape a Large Maze</a></h2><h3>Hard</h3><hr><p>There is a 1 million by 1 million grid on an XY-plane, and the coordinates of each grid square are <code>(x, y)</code>.</p>
